...
const DonorList = () => {
  ...
  return (
    <div className="relative p-2 sm:p-4 md:p-6 animate-fadeIn min-h-[80vh]">
      ...
      <div className="fixed bottom-6 right-6 z-30 flex items-center bg-sky-100 border border-sky-300 rounded-full px-4 py-2 shadow-lg text-sky-900 text-xs sm:text-sm font-mono font-bold gap-2 pointer-events-none select-none">
      ...
      <div className="bg-gradient-to-br from-orange-200 to-orange-300 rounded-xl shadow-xl overflow-hidden border border-orange-300">
        <div className="px-3 sm:px-4 md:px-6 py-5 border-b border-orange-400 flex flex-col md:flex-row md:items-center md:justify-between gap-3 md:gap-0 bg-gradient-to-br from-orange-300 to-orange-400 sticky top-0 z-20">
          <h3 className="text-xl md:text-2xl font-mono font-extrabold text-center text-white tracking-wider uppercase"> All Donors</h3>
          <div className="relative w-full md:w-auto flex items-center">
            ...
            <input
              ...
              className="w-full md:w-64 pl-9 pr-4 py-2.5 rounded-full border placeholder:font-mono placeholder:tracking-tight border-orange-300 focus:ring-2 focus:ring-orange-400 focus:border-orange-400 text-sm shadow-sm transition-all duration-150 bg-white/90 placeholder-orange-400"
          ...
          <table className="w-full table-auto rounded-xl overflow-hidden">
            <thead className="bg-orange-100/80 sticky top-0 z-10">
              <tr>
                ...
                <th className="hidden sm:table-cell px-2 sm:px-4 md:px-6 py-3 text-left text-sm font-mono font-extrabold text-orange-800 uppercase tracking-wider border-b border-orange-200 bg-orange-100/80">Blood Type</th>
                ...
                <th className="px-2 sm:px-4 md:px-6 py-3 text-left text-sm font-mono font-extrabold text-orange-800 uppercase tracking-wider border-b border-orange-200 bg-orange-100/80">Contact</th>
                ...
                filteredDonors.map((donor, idx) => (
                  ...
                  >
                    <td className="px-2 sm:px-4 md:px-6 py-4 whitespace-nowrap rounded-l-lg">
                      <div className="text-base font-mono font-semibold text-orange-900 capitalize">{donor.name}</div>
                    </td>
                    <td className="hidden md:table-cell px-2 sm:px-4 md:px-6 py-4 whitespace-nowrap font-mono font-semibold text-base text-orange-800 capitalize">
                      {donor.gender}
                    </td>
                    <td className="hidden sm:table-cell px-2 sm:px-4 md:px-6 py-4 whitespace-nowrap text-base font-mono font-extrabold text-orange-700">
                      {donor.blood_type}
                    </td>

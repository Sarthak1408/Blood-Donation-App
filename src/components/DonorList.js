...
const DonorList = () => {
  ...
  return (
    <div className="relative p-0 sm:p-4 md:p-2 animate-fadeIn min-h-[80vh]">
      ...
      <div className="bg-gradient-to-br from-orange-200 to-orange-300 rounded-xl shadow-xl overflow-hidden border border-orange-300">
        <div className="px-5 sm:px-4 md:px-6 py-5 border-b border-orange-400 flex flex-col md:flex-row md:items-center md:justify-between gap-3 md:gap-0 bg-gradient-to-br from-orange-300 to-orange-400 sticky top-0 z-20">
          <h3 className="text-xl md:text-2xl font-mono font-extrabold text-center text-white tracking-wider uppercase">
            {" "}
            All Donors
          </h3>
          <div className="relative w-full md:w-auto flex items-center">
            <svg
              className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-orange-500"
              fill="none"
              stroke="currentColor"
              strokeWidth="2"
              viewBox="0 0 24 24"
          ...
          <table className="w-full table-auto rounded-xl overflow-hidden">
            <thead className="bg-orange-100/80 sticky top-0 z-10">
              <tr>
                ...
                <th className="hidden sm:table-cell px-2 sm:px-4 md:px-6 py-3 text-left text-sm font-mono font-extrabold text-orange-800 uppercase tracking-wider border-b border-orange-200 bg-orange-100/80">
                  Gender
                </th>
